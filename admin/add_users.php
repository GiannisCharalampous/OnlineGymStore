...
if (isset($_POST['submit'])) {
    if (($_POST['username']) == '' ||
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
        {
            ...
            $mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address) VALUES('" . $_POST['username'] . "','" . $_POST['fname'] . "','" . $_POST['lname'] . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . md5($_POST['password']) . "','" . $_POST['address'] . "')";
            mysqli_query($db, $mql);
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="allgyms.php">All Stores</a></li>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone"
                                                           class="form-control form-control-danger" placeholder="phone">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
