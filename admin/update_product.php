...
if (isset($_POST['submit']))           //if upload btn is pressed
{
    ...
    if (empty($_POST['t_name']) || $_POST['price'] == '' || $_POST['gym_name'] == '') {
        ...
        $store = "Gym_img/equipment/" . basename($fnew);                      // the path to store the upload image
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "update gym_equipment set gym_id='$_POST[gym_name]',title='$_POST[t_name]',price='$_POST[price]',img='$fnew' where t_id='$_GET[product_upd]'";  // update the submited data ino the database :images
                mysqli_query($db, $sql);
                                ...
                                <li>
                                    <div class="message-center">
                                        ...
                                        <a href="#">
                                            ...
                                            <div class="mail-contnet">
                                                <h5>This is title</h5> <span class="mail-desc">Hello!</span>
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow  " href="#" aria-expanded="false"> <span><i class="fa fa-user f-s-20 "></i></span><span
                    ...
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i
                                    class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">GYM</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="allgyms.php">All GYMs</a></li>
                            <li><a href="add_gym.php">Add GYM</a></li>
            ...
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Add Product to the GYM</h4>
                    </div>
                    <div class="card-body">
                        <form action='' method='post' enctype="multipart/form-data">
                            <div class="form-body">
                                <?php $qml = "select * from gym_equipment where t_id='$_GET[product_upd]'";
                                $gym = mysqli_query($db, $qml);
                                $roww = mysqli_fetch_array($gym);
                                ?>
                                <hr>
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="t_name" value="<?php echo $roww['title']; ?>"
                                                   class="form-control" placeholder="Barbell">
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="gym_name" class="form-control custom-select"
                                                    data-placeholder="Choose a Category" tabindex="1">
                                                <option>--Select a GYM--</option>
                                                <?php $ssql = "select * from gym";
                                                $res = mysqli_query($db, $ssql);
                                                while ($row = mysqli_fetch_array($res)) {
                                                    echo ' <option value="' . $row['gym_id'] . '">' . $row['title'] . '</option>';;
                                                }
