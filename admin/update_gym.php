...
if (isset($_POST['submit']))           //if upload btn is pressed
{
    ...
    if (empty($_POST['gym_name']) || $_POST['email'] == '' || $_POST['phone'] == '' || $_POST['url'] == '' || $_POST['o_hr'] == '' || $_POST['c_hr'] == '' || $_POST['o_days'] == '' || $_POST['address'] == '') {
        ...
        $store = "Gym_img/" . basename($fnew);                      // the path to store the upload image
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $gym_name = $_POST['res_name'];

                $sql = "update gym set title='$gym_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where gym_id='$_GET[gym_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql);
                mysqli_query($db, $sql);
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i
                                    class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Store</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="allgyms.php">All GYMs</a></li>
                            <li><a href="add_gym.php">Add GYM</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i class="fa icon-present"
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    ...
                    <h4 class="m-b-0 ">Update GYM</h4>

                    <div class="card-body">
                        <form action='' method='post' enctype="multipart/form-data">
                            <div class="form-body">
                                <?php $ssql = "select * from gym where gym_id='$_GET[gym_upd]'";
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gym_name" value="<?php echo $row['title']; ?>"
