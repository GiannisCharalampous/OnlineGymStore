...
foreach ($_SESSION["cart_item"] as $item) {
    ...
    if ($_POST['submit']) {
        ...
        $success = "<br>Thank you! Your Order Placed successfully!";
    ...
    <header id="header" class="header-scroll top-header headrom">
        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/navbarLogo.jpg"
                                                               alt=""> </a>
                                                    ...
                                                    <input name="mod" type="radio" value="paypal" disabled
                                                           class="custom-control-input"> <span
                                                            ...
                                                            class="custom-control-description">Paypal <img
                                                                src="images/paypal.jpg" alt="" width="90px"></span>
                                                </label>
                                            </li>
                                        </ul>
    ...
    <div class="container">
        ...
        <div class="row top-footer">
            <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                <a href="#"> <img class="img-rounded" src="images/navbarLogo.jpg" alt="Footer logo"> </a>
                <span>GET Fit! </span>
            </div>
